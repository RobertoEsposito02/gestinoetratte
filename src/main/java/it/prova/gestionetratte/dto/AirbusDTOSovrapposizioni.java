...
public class AirbusDTOSovrapposizioni {
	...
	public AirbusDTOSovrapposizioni() {
	}
	
	public AirbusDTOSovrapposizioni(Long id, String codice, String descrizione, LocalDate dataInizioServizio, Integer numeroPasseggeri) {
		this.id = id;
		this.codice = codice;
	...
	public static AirbusDTOSovrapposizioni buildAirbusDTOFromModel(Airbus airbusModel, boolean includeTratte) {
		AirbusDTOSovrapposizioni result = new AirbusDTOSovrapposizioni(airbusModel.getId(), airbusModel.getCodice(), airbusModel.getDescrizione(),
	...
	public static List<AirbusDTOSovrapposizioni> createAirbusDTOListFromModelList(List<Airbus> modelListInput, boolean includeTratte) {
		return modelListInput.stream().map(airbusEntity -> {
			AirbusDTOSovrapposizioni result = AirbusDTOSovrapposizioni.buildAirbusDTOFromModel(airbusEntity, includeTratte);
			if (includeTratte)
